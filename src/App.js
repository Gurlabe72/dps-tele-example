...
const HomepageHeading = ({ mobile }) => (
  <Container text>
    ...
    <Header
      as='h2'
      content='Remote Monitoring & Control'
      inverted
      style={{
      ...
      <Grid container stackable verticalAlign='middle'>
        <Grid.Row>
          <Grid.Column width={8}>
            ...
            DPS Solutions
As a trusted provider of monitoring and control solutions for over 30 years...
            </Header>
            <p style={{ fontSize: '1.33em' }}>
            DPS Telecom will help you design a reliable system for collecting and managing alarm and control information. Serving utility, telecom, transportation and other companies with large distributed equipment networks, we offer a unique combination of master alarm management systems and remote telemetry units (RTUs) that provide end-to-end, single-vendor network monitoring.
            </p>
    ...
    <Segment style={{ padding: '8em 0em' }} vertical>
      <Container text>
        ...
        <p style={{ fontSize: '1.33em' }}>
        At DPS, selecting the right telemetry system is not just about selling off-the-shelf product into your network. We specialize in custom supervisory control and data acquisition solutions.
